...
# Generates lab2_task2.hex for the exact code currently in lab2_task2.asm
# (JMP vectors at 0x0000 and INT0addr, INT0 on PD2, LED on PD0)
...
# Layout (word addresses, matching the ASM):
...
$words.Add([uint16]0xC005) # rjmp off
$words.Add([uint16]0xC001) # rjmp on
